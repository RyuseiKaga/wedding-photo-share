...
function showSummary() {
  ...
  if (tracksEl && tracksEl.children.length === 0) {
    WEDDING_TRACKS.forEach(t => {
      ...
      appleBtn.innerHTML = `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="17" height="17" aria-hidden="true"><path fill="#FA2D48" d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm2.667 16.48c0 .177 0 .354-.006.53a2.4 2.4 0 01-.053.505 1.31 1.31 0 01-.21.47 1.24 1.24 0 01-.44.34 1.54 1.54 0 01-.601.178l-.154.005c-.357 0-.69-.109-.96-.323a1.224 1.224 0 01-.46-.882c-.011-.137-.005-.28.024-.418.111-.541.58-.929 1.135-.948.14-.005.282 0 .422 0h.064v-.108l-.002-3.172a2.39 2.39 0 00-.017-.29.373.373 0 00-.145-.258.459.459 0 00-.266-.082 1.72 1.72 0 00-.24.012l-3.445.612a.706.706 0 00-.26.089.451.451 0 00-.16.207.822.822 0 00-.053.278v5.73c0 .177-.005.354-.017.53a2.37 2.37 0 01-.058.505 1.303 1.303 0 01-.21.47 1.24 1.24 0 01-.44.34 1.54 1.54 0 01-.602.178l-.153.005c-.357 0-.691-.109-.96-.323a1.224 1.224 0 01-.46-.882 1.972 1.972 0 01.023-.418c.111-.541.581-.929 1.136-.948.14-.005.281 0 .422 0h.063V9.035c0-.2.006-.407.035-.605a2.07 2.07 0 01.354-.855 1.881 1.881 0 01.687-.552 2.44 2.44 0 01.699-.194l.218-.035 3.698-.66a2.044 2.044 0 01.288-.03c.294 0 .573.097.794.272.27.217.436.533.477.871.018.158.018.317.018.476v2.634z"/></svg>`;
